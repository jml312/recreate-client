...
function UserRecipes() {
  ...
  const [pageRecipes, setPageRecipes] = useState(currentUser.recipes);
  ...
  const { pagesQuantity, currentPage, setCurrentPage, pageSize } = usePaginator(
    {
      total: currentUser?.recipes?.length,
      initialState: {
        pageSize: 6,
        currentPage: 1,
      },
  ...
  return (
    <>
      <MetaTags>
        <title>{username}'s recipes | Recr-eat-e</title>
      </MetaTags>
      <Flex
        justify="center"
        align="center"
