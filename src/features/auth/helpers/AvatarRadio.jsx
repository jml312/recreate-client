import { Avatar, Box, Center, Tooltip, useRadio, useRadioGroup, Wrap, WrapItem } from "@chakra-ui/react";
...
function AvatarRadio({ currentAvatar, setSelectedAvatar,onClick }) {
  const options = [
    {
      name: "Gordon Ramsay",
